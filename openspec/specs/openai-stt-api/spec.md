...
Bridge capability exposing an OpenAI-compatible speech-to-text endpoint (`POST /v1/audio/transcriptions`) for clients such as openai-python and Hermes Agent.
